...
<p align="center">
  🌐 <a href="http://43.160.236.161:8060/">在线体验</a> · <code>http://43.160.236.161:8060/</code>
</p>

<p align="center">
  <a href="assets/docs/AgentTalk项目说明书.pdf"><img src="https://img.shields.io/badge/📄-项目说明书-8B5CF6?style=flat-square" /></a>
  <a href="assets/videos/AgentTalk介绍.mp4"><img src="https://img.shields.io/badge/🎬-演示视频-8B5CF6?style=flat-square" /></a>
  <a href="https://www.bilibili.com/video/BV1BVXpB4E9M"><img src="https://img.shields.io/badge/Bilibili-演示视频-00A1D6?style=flat-square&logo=bilibili&logoColor=white" /></a>
</p>
...
在这些交织的声音中，用户看到的不是"唯一正确的答案"，而是"原来这个问题还可以这样想"。AgentTalk 希望通过多元视角的碰撞，启迪独立思考，开阔每一位用户的认知边界。
...
| 🧠 | **人格工程驱动** | Agent 提示词由角色定义、思维模型、互动策略、语言风格、知识边界、系统级约束六维构建，差异深入认知层面 |
...
本项目为原创作品，所有架构设计、编排逻辑与业务代码均为独立开发完成。  
**请勿直接搬运或以任何形式将本项目代码冒充为自己的作品。** 如需引用或参考，请注明出处并附上本仓库链接。  
我们保留对抄袭行为追究责任的权利。
